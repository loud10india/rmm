            ...
            <div className='row'>
                <div className='col-lg-6 mb-md-60 mb-sm-30'>
                    ...
                    <ul className='nav nav-tabs services-tabs wow fadeInUp' data-wow-delay='0.55s' role='tablist'>
                        ...
                        <li role='presentation'>
                            <a href='#services-item-2' aria-controls='services-item-2' role='tab' aria-selected='false' data-bs-toggle='tab'>
                                Art Direction <span className='number'>02</span>
                            </a>
                        </li>
                        <li role='presentation'>
                            <a href='#services-item-3' aria-controls='services-item-3' role='tab' aria-selected='false' data-bs-toggle='tab'>
                                Creative Design <span className='number'>03</span>
                            </a>
                        </li>
                        <li role='presentation'>
                            <a href='#services-item-4' aria-controls='services-item-4' role='tab' aria-selected='false' data-bs-toggle='tab'>
                                Development <span className='number'>04</span>
                            </a>
                        </li>
                        <li role='presentation'>
                            <a href='#services-item-5' aria-controls='services-item-5' role='tab' aria-selected='false' data-bs-toggle='tab'>
                                Photography <span className='number'>05</span>
                            </a>
                        </li>
                        <li role='presentation'>
                            <a href='#services-item-6' aria-controls='services-item-6' role='tab' aria-selected='false' data-bs-toggle='tab'>
                            ...
                            <div className='services-text'>
                                <div className='services-text-container'>
                                    ...
                                    <p className='text-gray mb-0'>
                                        The core identity reflects consistent associations with the brand whereas the extended identity involves the
                                        intricate details of the brand that help generate a constant motif.
                                    </p>
                                </div>
                            </div>
                            <Image

            ...
            <div className='container min-height-100vh d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120'>
                ...
                <div className='bg-video-wrapper'>
                    <video ref={videoRef} className='bg-video' preload='auto' autoPlay muted loop>
                        <source src='/assets/videos/rmm-slide1.mov' type='video/mp4' />
                    </video>
                ...
                <div className='home-content'>
                    <div className='row'>
                        ...
                        <div className='col-md-10 offset-md-1 mb-20 mb-sm-0'>
                            <h2 className='hs-title-11 mb-30 mb-xs-10 wow fadeInUp'>Engineered for Excellence</h2>
                            <h1 className='hs-title-10 mb-50 mb-sm-30'>
                                <span className='wow charsAnimIn' data-splitting='chars'>
                                    Innovative Machinery for Marble & Granite Processing
                                </span>
                            </h1>
                            <div className='local-scroll wch-unset wow fadeInUp' data-wow-delay='0.4s'>
                                ...
                                <a href='#contact' className='btn btn-mod btn-w btn-large btn-round ms-1 me-1 mt-2 align-middle' data-btn-animate='y'>
                                    Get In Touch
                                </a>
                            </div>
                        </div>

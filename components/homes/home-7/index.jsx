        ...
        <>
                ...
                <div className='page-section bg-border-gradient pt-0 pb-0 scroll-nav-invisible z-index-1'>
                    <div className='page-section container position-relative scroll-nav-invisible'>
                        ...
                        <div className='decoration-image-1'>
                            <Image src='/assets/images/demo-gradient/section-image-6.jpg' alt='Image Description' width={336} height={406} />
                        </div>
                        {/* End Decoration Image */}
                        {/* Decoration Image */}
                        <div className='decoration-image-2'>
                            <Image src='/assets/images/demo-gradient/section-image-7.jpg' alt='Image Description' width={350} height={256} />
                        </div>
                        {/* End Decoration Image */}
                        <div className='row text-center'>
                            <div className='col-md-8 offset-md-2'>
                                <div className='text-center mb-40 mb-sm-30'>
                                    <Image src='/assets/images/demo-gradient/section-image-5.png' width={100} height={100} alt='Image Description' />
                                </div>
                                <p className='section-descr-medium mb-50 mb-sm-40'>
                                    Looking for exclusive creative services? Contact us and get free online consultation for your brand or your
                                    client's brand.
                                </p>
                ...
                <div className='container position-relative'>
                    <div className='row'>
                        <div className='col-lg-8 offset-lg-2 text-center'>
                            <h2 className='section-caption-gradient mb-20 mb-xs-10'>Our Portfolio</h2>
                    ...
                    <div className='row'>
                        <div className='col-lg-8 offset-lg-2 text-center'>
                            <p className='text-gray mb-70 mb-sm-50'>
                                In auctor ex id urna faucibus porttitor. In feugiat maximus nibh, id sodales mauris interdum at. Etiam eget lorem
                                odio. Duis scelerisque metus ac velit mattis, nec ultricies turpis posuere.
                            </p>
                        </div>
                    </div>
                    {/* Works Filter */}
            ...
            <section className='full-wrapper'>
                <div
                    className='page-section bg-dark-1 bg-dark-alpha-80 bg-scroll light-content round-large overflow-hidden'
                    style={{
                        backgroundImage: "url(/assets/images/demo-gradient/section-bg-2.jpg)",
                    }}
                >
                    <Banner />
                </div>
            ...
            <section
                className={`page-section ${dark ? " bg-dark-2 bg-dark-alpha-90 light-content" : "bg-gray-light-1 bg-light-alpha-90"}   bg-scroll`}
                style={{
            ...
            <section className={`page-section overflow-hidden   ${dark ? "bg-dark-2 light-content" : ""}`}>
                <Testimonials />
            </section>
            <section
                ...
                <div className='container position-relative'>
                    <div className='row wow fadeInUp'>
                        <div className='col-md-7 offset-md-5 col-lg-6 offset-lg-6 col-xl-5 offset-xl-7'>
                            <h2 className='section-title mb-40 mb-sm-30'>Design Jumpstart for Your Business</h2>
                            <p className='mb-50 mb-sm-40'>
                                Praesent venenatis justo in ultrices tempor. Donec maximus, dolor a condimentum congue, tellus nisi dictum magna,
                                uttere lorem ipsum viverra massa ex sit amet nulla. Duis lobortis nisl sed aliquam sollicitudin.
                            </p>
            ...
            <section className={`page-section  scrollSpysection   ${dark ? "bg-dark-1 light-content" : ""}`} id='contact'>
                <div className='row'>
                    <div className='col-lg-8 offset-lg-2 text-center'>
                        ...
                        <div className='section-line-gradient mx-auto mb-20' />
                        <h3 className='section-title mb-40 mb-sm-30'>Say hello, and we’ll start productive cooperation.</h3>
                        <p className='text-gray mb-80 mb-sm-60'>
                            Quisque semper nisl et mi tincidunt, at vulputate nunc tincidunt. Mauris a sapien nulla. Class aptent taciti sociosqu ad

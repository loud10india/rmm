        ...
        <div className='container position-relative'>
            <div className='row mb-80 mb-sm-60'>
                <div className='col-md-8 col-lg-6'>
                    <h2 className='section-title mb-0'>Three Simple Steps to Succeed at Design</h2>
                </div>
                <div className='col-lg-6 pt-20 pt-md-30'>
                    <p className='text-gray mb-0'>
                        ...
                        sed nisi eleifend, fermentum orcilorem amet, iaculis libero lorem. Sed lacinia quam eu velit eleifend lorem ipsum elementum
                        laoreet.
                    </p>
                </div>
            </div>

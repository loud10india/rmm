        ...
        <>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-6 d-flex align-items-center order-first order-lg-last mb-md-60 mb-sm-40'>
                            <div className='w-100 wow fadeInUp'>
                                <h2 className='section-caption-slick mb-30 mb-sm-20'>About Studio</h2>
                                <h3 className='section-title mb-30'>We believe in creatives with a&nbsp;passion to smart design.</h3>
                                <p className='text-gray mb-40'>
                                    Etiam fermentum vehicula faucibus. Praesent ullamcorper urna id arcu molestie scelerisque. Sed imperdiet tristique
                                    mauris et faucibus. Maecenas semper augue non fringilla placerat. Curabitur luctus erat sit amet ultricies
                                    aliquam. Donec dictum convallis mauris et maximus. Nullam massa arcu, porta quis felis et, eleifend varius quam.
                                </p>
                                {/* Features List */}
            ...
            <section className={`page-section  scrollSpysection  ${dark ? "bg-dark-1 light-content" : ""} `} id='portfolio'>
                <div className={`bg-shape-1 ${dark ? "opacity-003" : ""} `}>
                    <Image src='/assets/images/demo-slick/bg-shape-1.svg' width={1443} height={844} alt='' />
                </div>
                <div className='container position-relative'>
                    <div className='row mb-50 mb-sm-30'>
                        <div className='col-md-8 offset-md-2 text-center'>
                            <h2 className='section-caption-slick mb-30 mb-sm-20'>Selected Work</h2>
                            <h3 className='section-title mb-30'>We believe in making the best work, and being the best to work with.</h3>
                            <p className='section-descr mb-0'>
                                A static website stores a unique file for every page of a static website. Each time that page is requested, the same
                                content is returned.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className='col-lg-10 offset-lg-1 col-xl-8 offset-xl-2'>
                                <div className='row'>
                                    <div className='col-md-7 col-lg-8 text-center text-md-start mb-sm-20'>
                                        ...
                                        <p className='text-gray mb-0'>
                                            Quisque posuere mollis ullamcorper. Ut eget metus lorem ipsum posuere eget at ex. Aenean consequat vitae
                                            lorem in vehicula.
                                        </p>
                                    </div>
            ...
            <section className={`page-section  ${dark ? "bg-dark-1 light-content" : ""} `}>{dark ? <TestimonialsDark /> : <Testimonials />}</section>
            <hr className={`mt-0 mb-0 ${dark ? "white" : ""} `} />
